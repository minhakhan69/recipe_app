          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Image.asset(
                    'assets/images/letssssCookTogether.png',
                    height: 8.h,
                  ),
                ],
              ),
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Categories',
                    style: TextStyle(
                        fontSize: 0.285.dp, fontWeight: FontWeight.w700,color: Colors.brown.shade900),
                  ),
                  Text(
                    'see more',
                    style: TextStyle(
                        fontSize: 0.200.dp, fontWeight: FontWeight.w300,color: Colors.brown.shade900),
                  )
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Text(
                'All Recipes',
                style:
                    TextStyle(fontSize: 0.300.dp, fontWeight: FontWeight.w700,color: Colors.brown.shade900),
              ),
            ),
            // Expanded(
