...
class _FavouriteScreenState extends State<FavouriteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: Text('Farvouite'),),
        body: ListView.builder(
          ...
          return ListTile(
            leading: Padding(
              ...
              child: Image.asset(_favprovider.favoriteRecipes[index]['image'].toString()),
            ),
            title: Text((_favprovider.favoriteRecipes[index]['name'].toString()),),
          );
        },)
      ),
    );
